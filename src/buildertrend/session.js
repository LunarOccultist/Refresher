...
async function createAuthenticatedPage() {
  ...
  // Give Buildertrend extra time and avoid waiting for full network idle,
  // since the app may keep long-polling or opening websockets.
  page.setDefaultNavigationTimeout(120000);

  await page.goto(config.buildertrend.urls.landing, { waitUntil: 'domcontentloaded' });
